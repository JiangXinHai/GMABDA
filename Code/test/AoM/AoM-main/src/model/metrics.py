...
class AESCSpanMetric(object):
    def __init__(self,
        ...
        self.error_analysis_path=os.path.join('/home/jiangxinhai/GMABDA/Code/test/AoM/AoM-main/error_analysis',dataset)
            ...
            for key in aesc_pred_counter:
                ...
                if aesc_target_counter[key] == aesc_pred_counter[key]:
                    ...
                    if self.write_senti_wrong:
                        test_data=os.path.join('/home/jiangxinhai/GMABDA/Code/test/AoM/AoM-main/src/data/',self.dataset)
