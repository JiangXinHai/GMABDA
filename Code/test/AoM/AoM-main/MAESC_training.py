...
def main(rank, args):
    ...
    net.load_state_dict(torch.load('/home/jiangxinhai/GMABDA/Code/test/AoM/AoM-main/src/resnet/resnet152.pth'))
...
def parse_args():
    ...
    parser.add_argument('--trc_pretrain_file',
                        default='/home/jiangxinhai/GMABDA/Code/test/AoM/AoM-main/checkpoint_dir/2022-09-20-16-12-27/model60/pytorch_model.bin',
                        type=str,
                        help=' ')
    parser.add_argument('--trained_file',
                        default='/home/jiangxinhai/GMABDA/Code/test/AoM/AoM-main/train17/2022-11-23-16-49-35/pytorch_model.bin',
                        type=str,
                        help=' ')
    parser.add_argument('--senti_pretrain_file',
                        default='/home/jiangxinhai/GMABDA/Code/test/AoM/AoM-main/checkpoint_dir/2022-11-30-11-04-51/model45_minloss/pytorch_model.bin',
                        type=str,
                        help=' ')
    ...
    args.img_path=''
    if args.dataset[0][0]=='twitter15':
        args.img_path='/home/jiangxinhai/GMABDA/Data/twitter2015_images'
    elif args.dataset[0][0]=='twitter17':
        args.img_path='/home/jiangxinhai/GMABDA/Data/twitter2017_images'
    return args
